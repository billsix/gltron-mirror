 ...
 *
 * $Id: io.h,v 1.1 2004/05/31 08:01:30 andi75 Exp $
 */
...
typedef int (*Lib3dsIoWriteFunc)(void* self, const Lib3dsByte* buffer,
                                 int size);

extern LIB3DSAPI Lib3dsIo* lib3ds_io_new(void* self,
...
extern LIB3DSAPI long lib3ds_io_seek(Lib3dsIo* io, long offset,
                                     Lib3dsIoSeek origin);
...
extern LIB3DSAPI int lib3ds_io_write(Lib3dsIo* io, const Lib3dsByte* buffer,
                                     int size);
...
extern LIB3DSAPI Lib3dsBool lib3ds_io_read_string(Lib3dsIo* io, char* s,
                                                  int buflen);
...
extern LIB3DSAPI Lib3dsBool lib3ds_io_write_vector(Lib3dsIo* io,
                                                   Lib3dsVector v);
