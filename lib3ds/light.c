 ...
 *
 * $Id: light.c,v 1.1 2004/05/31 08:01:30 andi75 Exp $
 */
...
Lib3dsBool lib3ds_light_write(Lib3dsLight* light, Lib3dsIo* io) {
  ...
  if (light->spot_light) {
    ...
    if (fabs(light->spot_aspect) >
        LIB3DS_EPSILON) { /*---- LIB3DS_DL_SPOT_ASPECT ----*/
      Lib3dsChunk c;
    ...
    if (fabs(light->ray_bias) >
        LIB3DS_EPSILON) { /*---- LIB3DS_DL_RAY_BIAS ----*/
      Lib3dsChunk c;
