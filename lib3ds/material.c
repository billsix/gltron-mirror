 ...
 *
 * $Id: material.c,v 1.1 2004/05/31 08:01:30 andi75 Exp $
 */
...
static Lib3dsBool color_read(Lib3dsRgba rgb, Lib3dsIo* io) {
  Lib3dsChunk c;
  Lib3dsWord chunk;
 ...
 * \ingroup material
 */
static void texture_dump(const char* maptype, Lib3dsTextureMap* texture) {
  ASSERT(texture);
  ...
  printf("    rotation:    %f\n", texture->rotation);
  printf("    tint_1:      (%f, %f, %f)\n", texture->tint_1[0],
         texture->tint_1[1], texture->tint_1[2]);
  printf("    tint_2:      (%f, %f, %f)\n", texture->tint_2[0],
         texture->tint_2[1], texture->tint_2[2]);
  printf("    tint_r:      (%f, %f, %f)\n", texture->tint_r[0],
         texture->tint_r[1], texture->tint_r[2]);
  printf("    tint_g:      (%f, %f, %f)\n", texture->tint_g[0],
         texture->tint_g[1], texture->tint_g[2]);
  printf("    tint_b:      (%f, %f, %f)\n", texture->tint_b[0],
         texture->tint_b[1], texture->tint_b[2]);
}
...
static Lib3dsBool color_write(Lib3dsRgba rgb, Lib3dsIo* io) {
  Lib3dsChunk c;
...
static Lib3dsBool texture_map_write(Lib3dsWord chunk, Lib3dsTextureMap* map,
                                    Lib3dsIo* io) {
  Lib3dsChunk c;
...
Lib3dsBool lib3ds_material_write(Lib3dsMaterial* material, Lib3dsIo* io) {
  ...
  if (!texture_map_write(LIB3DS_MAT_SELFIMASK, &material->self_illum_mask,
                         io)) {
    return (LIB3DS_FALSE);
  }
