 ...
 *
 * $Id: matrix.c,v 1.1 2004/05/31 08:01:30 andi75 Exp $
 */
...
static Lib3dsFloat det2x2(Lib3dsFloat a, Lib3dsFloat b, Lib3dsFloat c,
                          Lib3dsFloat d) {
  return ((a) * (d) - (b) * (c));
}

static Lib3dsFloat det3x3(Lib3dsFloat a1, Lib3dsFloat a2, Lib3dsFloat a3,
 ...
 * \ingroup matrix
 */
void lib3ds_matrix_translate_xyz(Lib3dsMatrix m, Lib3dsFloat x, Lib3dsFloat y,
                                 Lib3dsFloat z) {
  int i;
 ...
 * \ingroup matrix
 */
void lib3ds_matrix_scale_xyz(Lib3dsMatrix m, Lib3dsFloat x, Lib3dsFloat y,
                             Lib3dsFloat z) {
  int i;
 ...
 * \ingroup matrix
 */
void lib3ds_matrix_rotate_axis(Lib3dsMatrix m, Lib3dsVector axis,
                               Lib3dsFloat angle) {
  Lib3dsQuat q;
 ...
 * \ingroup matrix
 */
void lib3ds_matrix_camera(Lib3dsMatrix matrix, Lib3dsVector pos,
