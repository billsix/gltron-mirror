 ...
 *
 * $Id: node.c,v 1.1 2004/05/31 08:01:30 andi75 Exp $
 */
...
static const char* node_names_table[] = {
    "***Unknown***", "Ambient", "Object", "Camera", "Target", "Light", "Spot"};
...
Lib3dsBool lib3ds_node_write(Lib3dsNode* node, Lib3dsFile* file, Lib3dsIo* io) {
  ...
  switch (c.chunk) {
    ...
    case LIB3DS_OBJECT_NODE_TAG: { /*---- LIB3DS_PIVOT ----*/
      ...
      if (node->data.object.hide_track
              .keyL) { /*---- LIB3DS_HIDE_TRACK_TAG ----*/
        Lib3dsChunk c;
      ...
      if (fabs(node->data.object.morph_smooth) >
          LIB3DS_EPSILON) { /*---- LIB3DS_MORPH_SMOOTH ----*/
        Lib3dsChunk c;
