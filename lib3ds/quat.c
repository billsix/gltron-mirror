 ...
 *
 * $Id: quat.c,v 1.1 2004/05/31 08:01:30 andi75 Exp $
 */
 ...
 * \ingroup quat
 */
void lib3ds_quat_zero(Lib3dsQuat c) { c[0] = c[1] = c[2] = c[3] = 0.0f; }
 ...
 * \ingroup quat
 */
void lib3ds_quat_axis_angle(Lib3dsQuat c, Lib3dsVector axis,
                            Lib3dsFloat angle) {
...
Lib3dsFloat lib3ds_quat_length(Lib3dsQuat c) {
  return (
      (Lib3dsFloat)sqrt(c[0] * c[0] + c[1] * c[1] + c[2] * c[2] + c[3] * c[3]));
}
 ...
 * \ingroup quat
 */
void lib3ds_quat_slerp(Lib3dsQuat c, Lib3dsQuat a, Lib3dsQuat b,
                       Lib3dsFloat t) {
  Lib3dsDouble l;
  Lib3dsDouble om, sinom;
  Lib3dsDouble sp, sq;
 ...
 * \ingroup quat
 */
void lib3ds_quat_tangent(Lib3dsQuat c, Lib3dsQuat p, Lib3dsQuat q,
                         Lib3dsQuat n) {
  Lib3dsQuat dn, dp, x;
  int i;
