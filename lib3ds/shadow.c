 ...
 *
 * $Id: shadow.c,v 1.1 2004/05/31 08:01:30 andi75 Exp $
 */
...
Lib3dsBool lib3ds_shadow_write(Lib3dsShadow* shadow, Lib3dsIo* io) {
  if (fabs(shadow->lo_bias) >
      LIB3DS_EPSILON) { /*---- LIB3DS_LO_SHADOW_BIAS ----*/
    Lib3dsChunk c;
  ...
  if (fabs(shadow->hi_bias) >
      LIB3DS_EPSILON) { /*---- LIB3DS_HI_SHADOW_BIAS ----*/
    Lib3dsChunk c;
  ...
  if (fabs(shadow->filter) >
      LIB3DS_EPSILON) { /*---- LIB3DS_SHADOW_FILTER ----*/
    Lib3dsChunk c;
