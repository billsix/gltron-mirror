...
#define SYSTEM_KEY_ENTER SDLK_RETURN
#define SYSTEM_KEY_RETURN SDLK_RETURN

#define SYSTEM_MOUSEUP SDL_EVENT_MOUSE_BUTTON_UP
#define SYSTEM_MOUSEDOWN SDL_EVENT_MOUSE_BUTTON_DOWN

/* SDL3 dropped SDL_PRESSED/SDL_RELEASED; mouse button events expose a `down`
   bool instead. The values below preserve the legacy semantics so callers in
   src/game/ keep compiling unchanged. */
...
enum { NEBU_INPUT_KEYSTATE_DOWN = 1, NEBU_INPUT_KEYSTATE_UP = 2 };
