...
unsigned char* scalePixelBitmap(unsigned char* source, int sw, int sh, int posx,
                                int posy, int width, int height, int dw, int dh,
                                int bytes) {
  int x, y;
  unsigned char* data;
  unsigned char byte;
...
unsigned char* scalePixels(const unsigned char* source, int sw, int sh,
                           int posx, int posy, int width, int height, int dw,
                           int dh, int bytes) {
  int x, y;
  unsigned char* data;
  /*
