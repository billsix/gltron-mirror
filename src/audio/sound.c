...
#if 1
    "game_engine.wav", "game_crash.wav", "game_recognizer.wav"
#else
    "game_engine.ogg", "game_crash.ogg", "game_recognizer.ogg"
#endif
};
...
void Sound_shutdown(void) { Audio_Quit(); }

void Sound_load(char* name) { Audio_LoadMusic(name); }
...
void Sound_stop(void) { Audio_StopMusic(); }

void Sound_idle(void) { Audio_Idle(); }
