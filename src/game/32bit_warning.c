...
void _32bit_warning_Display(void) {
  ...
  // draw warning
  if (1) {
    nebu_Font* ppFont[5] = {pInfoFont, pInfoFont, pInfoFont, pInfoFont,
                            pInfoFont};
    char text[5][100] = {
        "Warning - 32bit color depth", "not available - Please set ",
        "your desktop bitdepth to   ", "32bit (high color) to      ",
...
Callbacks _32bit_warningCallbacks = {_32bit_warning_Display,  // display
