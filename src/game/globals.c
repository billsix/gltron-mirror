...
char* lc_lod_names[] = {"lightcycle-high.obj", "lightcycle-med.obj",
                        "lightcycle-low.obj"};
...
unsigned char debugcolors[6][4] = {{0, 0, 0, 0},       {255, 0, 0, 255},
...
TextureInfo textures[TEX_COUNT] = {
    {1, "gltron_trail.png", GL_RGBA, GL_CLAMP_TO_EDGE, GL_CLAMP_TO_EDGE,
     TEX_TRAIL, 1},
    {1, "gltron_traildecal.png", GL_RGBA, GL_REPEAT, GL_CLAMP_TO_EDGE,
     TEX_DECAL, 1},
    {1, "skybox0.png", GL_RGB, GL_CLAMP_TO_EDGE, GL_CLAMP_TO_EDGE, TEX_SKYBOX0,
     1},
    {1, "skybox1.png", GL_RGB, GL_CLAMP_TO_EDGE, GL_CLAMP_TO_EDGE, TEX_SKYBOX1,
     1},
    {1, "skybox2.png", GL_RGB, GL_CLAMP_TO_EDGE, GL_CLAMP_TO_EDGE, TEX_SKYBOX2,
     1},
    {1, "skybox3.png", GL_RGB, GL_CLAMP_TO_EDGE, GL_CLAMP_TO_EDGE, TEX_SKYBOX3,
     1},
    {1, "skybox4.png", GL_RGB, GL_CLAMP_TO_EDGE, GL_CLAMP_TO_EDGE, TEX_SKYBOX4,
     1},
    {1, "skybox5.png", GL_RGB, GL_CLAMP_TO_EDGE, GL_CLAMP_TO_EDGE, TEX_SKYBOX5,
     1},
    {1, "gltron_impact.png", GL_RGBA, GL_REPEAT, GL_CLAMP_TO_EDGE, TEX_IMPACT,
     1},
};
...
#define LX 2.0f
#define LY 2.0f
float shadow_matrix[] = {LX * LY, 0,   0, 0, 0, LX* LY, 0, 0,
                         -LY,     -LX, 0, 0, 0, 0,      0, LX* LY};
#undef LX
#undef LY
