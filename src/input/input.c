...
int ReservedKeyCodes[eReservedKeys] = {27,
                                       ' ',
                                       SYSTEM_KEY_F1,
                                       SYSTEM_KEY_F2,
                                       SYSTEM_KEY_F3,
...
void keyGame(int state, int k, int x, int y) {
  ...
  const int ascii_offset_between_capital_and_lowercase = 32;
  ...
  while (argc--) {
    if (argv[argc][0] == '-') {
      ...
      while (argv[argc][++i] != 0) {
        switch (argv[argc][i]) {
          case 'x':
            setSettingi("show_crash_texture", 0);
            break;
          case 'F':
            setSettingi("show_fps", 0);
            break;
          case 't':
            setSettingi("show_floor_texture", 0);
            break;
          case 'c':
            setSettingi("show_ai_status", 0);
            break;
          case 'g':
            setSettingi("show_glow", 0);
            break;
          case 'w':
            setSettingi("show_wall", 0);
            break;
          case 'C':
          ...
          case 'i':
            ...
            break;
          case 'O':
            setSettingi("softwareRendering", 1);
            break;
          case '1': /* default is 4 */
          ...
          default:
            ...
            printf(
                "-t\tdon't display floor texture, use lines instead"
                "(huge speed gain)\n");
            ...
            printf(
                "-O\tenable software rendering optimization (only if "
